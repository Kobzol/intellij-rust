...
class CratesLocalIndexService : PersistentStateComponent<CratesLocalIndexState>, CrateResolverService, Disposable {
...
fun crateFromJson(json: String): CargoRegistryCrateVersion {
