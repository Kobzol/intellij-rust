...
abstract class TyPrimitive : Ty() {
    ...
    protected open fun copyWithAlias(aliasedBy: BoundElement<RsTypeAlias>?): Ty = this

    override fun withAlias(aliasedBy: BoundElement<RsTypeAlias>): Ty = copyWithAlias(aliasedBy)

    override fun superFoldWith(folder: TypeFolder): Ty = copyWithAlias(aliasedBy?.foldWith(folder))
...
class TyBool(override val aliasedBy: BoundElement<RsTypeAlias>? = null) : TyPrimitive() {
    ...
    override fun copyWithAlias(aliasedBy: BoundElement<RsTypeAlias>?): Ty = TyBool(aliasedBy)
...
class TyChar(override val aliasedBy: BoundElement<RsTypeAlias>? = null) : TyPrimitive() {
    ...
    override fun copyWithAlias(aliasedBy: BoundElement<RsTypeAlias>?): Ty = TyChar(aliasedBy)
...
class TyUnit(override val aliasedBy: BoundElement<RsTypeAlias>? = null) : TyPrimitive() {
    ...
    override fun copyWithAlias(aliasedBy: BoundElement<RsTypeAlias>?): Ty = TyUnit(aliasedBy)
...
class TyStr(override val aliasedBy: BoundElement<RsTypeAlias>? = null) : TyPrimitive() {
    ...
    override fun copyWithAlias(aliasedBy: BoundElement<RsTypeAlias>?): Ty = TyStr(aliasedBy)
...
sealed class TyInteger : TyNumeric() {
    ...
    class U8(override val aliasedBy: BoundElement<RsTypeAlias>? = null): TyInteger() {
        ...
        override fun copyWithAlias(aliasedBy: BoundElement<RsTypeAlias>?): Ty = U8(aliasedBy)
    ...
    class U16(override val aliasedBy: BoundElement<RsTypeAlias>? = null): TyInteger() {
        ...
        override fun copyWithAlias(aliasedBy: BoundElement<RsTypeAlias>?): Ty = U16(aliasedBy)
    ...
    class U32(override val aliasedBy: BoundElement<RsTypeAlias>? = null): TyInteger() {
        ...
        override fun copyWithAlias(aliasedBy: BoundElement<RsTypeAlias>?): Ty = U32(aliasedBy)
    ...
    class U64(override val aliasedBy: BoundElement<RsTypeAlias>? = null): TyInteger() {
        ...
        override fun copyWithAlias(aliasedBy: BoundElement<RsTypeAlias>?): Ty = U64(aliasedBy)
    ...
    class U128(override val aliasedBy: BoundElement<RsTypeAlias>? = null): TyInteger() {
        ...
        override fun copyWithAlias(aliasedBy: BoundElement<RsTypeAlias>?): Ty = U128(aliasedBy)
    ...
    class USize(override val aliasedBy: BoundElement<RsTypeAlias>? = null): TyInteger() {
        ...
        override fun copyWithAlias(aliasedBy: BoundElement<RsTypeAlias>?): Ty = USize(aliasedBy)
    ...
    class I8(override val aliasedBy: BoundElement<RsTypeAlias>? = null): TyInteger() {
        ...
        override fun copyWithAlias(aliasedBy: BoundElement<RsTypeAlias>?): Ty = I8(aliasedBy)
    ...
    class I16(override val aliasedBy: BoundElement<RsTypeAlias>? = null): TyInteger() {
        ...
        override fun copyWithAlias(aliasedBy: BoundElement<RsTypeAlias>?): Ty = I16(aliasedBy)
    ...
    class I32(override val aliasedBy: BoundElement<RsTypeAlias>? = null): TyInteger() {
        ...
        override fun copyWithAlias(aliasedBy: BoundElement<RsTypeAlias>?): Ty = I32(aliasedBy)
    ...
    class I64(override val aliasedBy: BoundElement<RsTypeAlias>? = null): TyInteger() {
        ...
        override fun copyWithAlias(aliasedBy: BoundElement<RsTypeAlias>?): Ty = I64(aliasedBy)
    ...
    class I128(override val aliasedBy: BoundElement<RsTypeAlias>? = null): TyInteger() {
        ...
        override fun copyWithAlias(aliasedBy: BoundElement<RsTypeAlias>?): Ty = I128(aliasedBy)
    ...
    class ISize(override val aliasedBy: BoundElement<RsTypeAlias>? = null): TyInteger() {
        ...
        override fun copyWithAlias(aliasedBy: BoundElement<RsTypeAlias>?): Ty = ISize(aliasedBy)
...
sealed class TyFloat : TyNumeric() {
    ...
    class F32(override val aliasedBy: BoundElement<RsTypeAlias>? = null): TyFloat() {
        ...
        override fun copyWithAlias(aliasedBy: BoundElement<RsTypeAlias>?): Ty = F32(aliasedBy)
    ...
    class F64(override val aliasedBy: BoundElement<RsTypeAlias>? = null): TyFloat() {
        ...
        override fun copyWithAlias(aliasedBy: BoundElement<RsTypeAlias>?): Ty = F64(aliasedBy)
