...
private class MembersGenerator(
    ...
    private val renderer = ImportingPsiRenderer(pathPsiSubst(impl.traitRef!!.path, trait.element), impl.members!!)
    ...
    private fun renderFunctionSignature(fn: RsFunction): String {
        return renderer.renderFunctionSignature(fn, true)
    }

    fun RsTypeReference.renderTypeReference(): String =
        renderer.renderTypeReference(this, renderLifetimes = true)
}
